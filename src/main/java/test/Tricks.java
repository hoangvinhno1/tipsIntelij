...
public class Tricks {
	...
	//upper case and lower case ctrl+shift+u
	private static final String PI = "vuonghoangvinh";
	...
	String sql = "select * from a where a.id = 1";
	//multi line String
...
//			"the popup in File | Settings | Appearance & Behavior | Menus and Toolbars";
	String longText = "The basic way to select a piece of text is to extend the selection with the" +
			...
			" keys to make selections.";//	Go to Editor | Live Templates in the settings and add
	// a new template
//	// formatter:off
//	    $SELECTION$
//	// formatter:on
